...
import AuthModal from "../authenticationpage/AuthModal"; // Importado o modal de autenticação
...
export default function Home() {
  ...
  const handleAuthSuccess = () => {
    ...
    navigate("/dash"); // Ao logar com sucesso pela Home, vai direto para o painel
  };
      ...
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          <div className={styles.cta}>
            ...
            {/* Modificado: Agora abre o Pop-up de Login */}
            <Button onClick={() => setShowLoginModal(true)} className={styles.homeLoginButton}>
              Já tenho uma conta
            </Button>
        ...
        {/* RENDERIZAÇÃO DO POP-UP NA HOME */}
        {showLoginModal && (
            <AuthModal
                mode="login" // Força a abertura estritamente em modo de Login
                onClose={() => setShowLoginModal(false)}
                onSwitchMode={() => setShowLoginModal(false)} // Se ele não tiver conta, fecha ou redireciona
